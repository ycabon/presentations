...
import CustomFeatureLayer6 from "./CustomFeatureLayer";
...
export default class CustomFeatureLayerView extends declared(BaseLayerViewGL2D) {
  ...
  attach() {
    ...
    watchUtils.init(this, "layer.minMaxDaysSinceUpate", (minMax) => {
      this._minMinMaxVV[0] = minMax[0];
      this._minMinMaxVV[1] = minMax[1];
      this.requestRender();
    });
    ...
    const layer = this.layer as CustomFeatureLayer6;
  ...
  render(renderParameters: any) {
    ...
    // min/max ranges (values and sizes)
