...
**Referenced by:** [presentation](presentation.md)
...
| environment | Represents settings that affect the environment in which the web scene is displayed.<br>See [environment properties](#environment-properties) table.
| [ground](slide_ground.md) | The ground properties to be set in the slide.
| id | The unique id of a slide within the slides property of a Presentation.
| [thumbnail](thumbnail.md) | Object containing a thumbnail image.
