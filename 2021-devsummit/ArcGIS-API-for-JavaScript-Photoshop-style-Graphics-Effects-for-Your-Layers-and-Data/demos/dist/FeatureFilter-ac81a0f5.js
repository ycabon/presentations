import { k as i, p as s$1, aF as t$1, dn as R, E as f, bq as c, C as u } from './_virtual:index-1982596a.js';
import { W, Y, n } from './timeSupport-fc4fc4a7.js';
import { d } from './FeatureStore2D-556ef92d.js';
import './quantizationUtils-00a9c519.js';
import './json-dc26b8a4.js';
import './quickselect-09389b48.js';
import './aaBoundingBox-77437eb6.js';

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.18/esri/copyright.txt for details.
*/
const t=i.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(e,s){const n=await import('./WhereClause-4300def2.js');try{const o=n.WhereClause.create(e,s);if(!o.isStandardized){const e=new s$1("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(e);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(r){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",e),e=>!0}}
