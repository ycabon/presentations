...
import { W, Y, n } from './timeSupport-13ae9523.js';
import { d } from './FeatureStore2D-774d6adf.js';
...
*/
const t=i.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(e,s){const n=await import('./WhereClause-912d538d.js');try{const o=n.WhereClause.create(e,s);if(!o.isStandardized){const e=new s$1("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(e);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(r){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",e),e=>!0}}
