(function () {
    ...
    function render() {
        ...
        return (jsx("div", { style: "width: 100%; height: 100%; display: flex; flex-direction: row; justify-content: space-around; align-items: center" },
            jsx("div", { style: "padding: 12px; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.3)" },
                renderLocaleSelect(),
            ...
            jsx("div", { style: "padding: 12px; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.3);" },
                jsx("p", { style: "font-size: xxx-large;" }, getFormattedDate(formatLocale, renderedFormatOptions)))));
    }
    function renderLocaleSelect() {
        return (jsx("calcite-select", { afterCreate: afterCreateEventHandler("calciteSelectChange", (event) => {
    ...
    function renderRadioButtonGroup(property, values, formatOptions) {
        return (jsx("calcite-label", { key: property },
            property,
            jsx("calcite-radio-group", { afterCreate: radioHandler(property) }, values.map((value) => {
                return (jsx("calcite-radio-group-item", { value: value, checked: formatOptions[property] === value }, value));
            }))));
    }
