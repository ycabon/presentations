import { e as s$1, s as s$2, aA as u, gI as b, aJ as c, h as r } from './_virtual_index-3ad07138.js';
import { Z, v, n } from './spatialQuerySupport-a8f4c6a3.js';
import { u as u$1 } from './FeatureStore2D-93ccff49.js';
import './projectionSupport-f3b66f92.js';
import './json-2bf9d675.js';
import './CircularArray-084395da.js';
...
*/
const t=s$1.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(r,s){const n=await import('./WhereClause-5bd88617.js');try{const o=n.WhereClause.create(r,s);if(!o.isStandardized){const r=new s$2("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(r);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(o){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),e=>!0}}
