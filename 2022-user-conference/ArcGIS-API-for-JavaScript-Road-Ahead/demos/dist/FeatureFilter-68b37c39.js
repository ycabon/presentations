import { Z as s$1, s as s$2, bE as u, d as b, xu as v, bY as c, t as t$1 } from './_virtual_index-9b831d4a.js';
import { v as v$1, n } from './timeSupport-a77eca3d.js';
import { u as u$1 } from './FeatureStore2D-b509c043.js';
...
*/
const t=s$1.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(r,s){const n=await import('./_virtual_index-9b831d4a.js').then(function (n) { return n.yz; });try{const o=n.WhereClause.create(r,s);if(!o.isStandardized){const r=new s$2("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(r);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(o){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),e=>!0}}
