import { C as s$1, s as s$2, aN as u, iu as b, nd as v, b5 as c, O as t$1 } from './_virtual_index-64b818a8.js';
import { v as v$1, n } from './timeSupport-d58fe9b7.js';
import { u as u$1 } from './FeatureStore2D-4f3c2c52.js';
import './CircularArray-5e187743.js';
...
*/
const t=s$1.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(r,s){const n=await import('./_virtual_index-64b818a8.js').then(function (n) { return n.pn; });try{const o=n.WhereClause.create(r,s);if(!o.isStandardized){const r=new s$2("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(r);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(o){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),e=>!0}}
