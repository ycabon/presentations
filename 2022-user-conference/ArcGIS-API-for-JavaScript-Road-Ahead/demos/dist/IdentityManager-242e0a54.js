import { u as e$1, y, fs as e$2, z as n, ft as M, fw as n$1, m8 as s$3, m9 as v, b7 as l$2, eq as n$2, ma as e$3, ju as l$3, b1 as n$3, mb as s$4, mc as p$3, n as j$1, aH as D$1, av as v$1, E as s$5, dk as p$4, md as z, me as y$1, U, mf as L$1, mg as Z, b6 as r$1, mh as I, mi as t$1, aD as s$6, mj as F, mk as J, ml as t$2, mm as Q, mn as Bt, mo as n$4 } from './_virtual_index-1ea2035a.js';

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.25/esri/copyright.txt for details.
*/
const a={base:"esri-identity-form",group:"esri-identity-form__group",label:"esri-identity-form__label",footer:"esri-identity-form__footer",esriInput:"esri-input",esriButton:"esri-button",esriButtonSecondary:"esri-button--secondary"},l$1="ArcGIS Online";let p$2=class extends M{constructor(s,e){super(s,e),this._usernameInputNode=null,this._passwordInputNode=null,this.signingIn=!1,this.server=null,this.resource=null,this.error=null,this.oAuthPrompt=!1;}render(){const{error:s,server:e,resource:t,signingIn:o,oAuthPrompt:n,messages:p}=this,d=n$1("div",{class:a.group},s$3(n?p.oAuthInfo:p.info,{server:e&&/\.arcgis\.com/i.test(e)?l$1:e,resource:`(${t||p.lblItem})`})),c=n?null:n$1("div",{class:a.group,key:"username"},n$1("label",{class:a.label},p.lblUser,n$1("input",{value:"",required:!0,autocomplete:"off",spellcheck:!1,type:"text",bind:this,afterCreate:v,"data-node-ref":"_usernameInputNode",class:a.esriInput}))),m=n?null:n$1("div",{class:a.group,key:"password"},n$1("label",{class:a.label},p.lblPwd,n$1("input",{value:"",required:!0,type:"password",bind:this,afterCreate:v,"data-node-ref":"_passwordInputNode",class:a.esriInput}))),h=n$1("div",{class:this.classes(a.group,a.footer)},n$1("input",{type:"submit",disabled:!!o,value:o?p.lblSigning:p.lblOk,class:a.esriButton}),n$1("input",{type:"button",value:p.lblCancel,bind:this,onclick:this._cancel,class:this.classes(a.esriButton,a.esriButtonSecondary)})),b=s?n$1("div",null,s.details&&s.details.httpStatus?p.invalidUser:p.noAuthService):null;return n$1("form",{class:a.base,bind:this,onsubmit:this._submit},d,b,c,m,h)}_cancel(){this._set("signingIn",!1),this._usernameInputNode&&(this._usernameInputNode.value=""),this._passwordInputNode&&(this._passwordInputNode.value=""),this.emit("cancel");}_submit(s){s.preventDefault(),this._set("signingIn",!0);const e=this.oAuthPrompt?{}:{username:this._usernameInputNode&&this._usernameInputNode.value,password:this._passwordInputNode&&this._passwordInputNode.value};this.emit("submit",e);}};e$1([y(),e$2("esri/identity/t9n/identity")],p$2.prototype,"messages",void 0),e$1([y()],p$2.prototype,"signingIn",void 0),e$1([y()],p$2.prototype,"server",void 0),e$1([y()],p$2.prototype,"resource",void 0),e$1([y()],p$2.prototype,"error",void 0),e$1([y()],p$2.prototype,"oAuthPrompt",void 0),p$2=e$1([n("esri.identity.IdentityForm")],p$2);const d=p$2;
...
See https://js.arcgis.com/4.25/esri/copyright.txt for details.
*/
const l={base:"esri-identity-modal",open:"esri-identity-modal--open",closed:"esri-identity-modal--closed",title:"esri-identity-modal__title",dialog:"esri-identity-modal__dialog",content:"esri-identity-modal__content",closeButton:"esri-identity-modal__close-button",iconClose:"esri-icon-close"};let p$1=class extends M{constructor(t,e){super(t,e),this.container=document.createElement("div"),this.content=null,this.open=!1,this._focusTrap=null,this._close=()=>{this.open=!1;},document.body.appendChild(this.container),this.addHandles(l$2((()=>this.open),(()=>this._toggleFocusTrap())));}destroy(){this._destroyFocusTrap();}get title(){return this.messages?.auth.signIn}render(){const t=this.id,{open:e,content:o,title:s,messages:i}=this,r=e&&!!o,n={[l.open]:r,[l.closed]:!r},a=n$1("button",{class:l.closeButton,"aria-label":i.close,title:i.close,bind:this,onclick:this._close,type:"button"},n$1("span",{"aria-hidden":"true",class:l.iconClose})),d=`${t}_title`,p=`${t}_content`,u=s?n$1("h1",{id:d,class:l.title},s):null,m=r?n$1("div",{bind:this,class:l.dialog,role:"dialog","aria-labelledby":d,"aria-describedby":p,afterCreate:this._createFocusTrap},a,u,this._renderContent(p)):null;return n$1("div",{tabIndex:-1,class:this.classes(l.base,n)},m)}_destroyFocusTrap(){this._focusTrap?.deactivate({onDeactivate:()=>{}}),this._focusTrap=null;}_toggleFocusTrap(){const{_focusTrap:t,open:e}=this;t&&(e?t.activate():t.deactivate());}_createFocusTrap(t){this._destroyFocusTrap();const o=requestAnimationFrame((()=>{this._focusTrap=createFocusTrap(t,{initialFocus:"input",onDeactivate:this._close}),this._toggleFocusTrap();}));this.addHandles(n$2((()=>cancelAnimationFrame(o))));}_renderContent(t){const e=this.content;return "string"==typeof e?n$1("div",{class:l.content,id:t,innerHTML:e}):e$3(e)?n$1("div",{class:l.content,id:t},e.render()):e instanceof HTMLElement?n$1("div",{class:l.content,id:t,bind:e,afterCreate:this._attachToNode}):null}_attachToNode(t){const e=this;t.appendChild(e);}};e$1([y({readOnly:!0})],p$1.prototype,"container",void 0),e$1([y()],p$1.prototype,"content",void 0),e$1([y()],p$1.prototype,"open",void 0),e$1([y(),e$2("esri/t9n/common")],p$1.prototype,"messages",void 0),e$1([y()],p$1.prototype,"title",null),p$1=e$1([n("esri.identity.IdentityModal")],p$1);const u=p$1;
