import { u as e$1, y, z as n$2, ju as l$2, mL as T, mA as r, Y as y$1, mC as p$3, my as c$1, mD as v, mv as t$1, mz as O, mE as i$2, nq as y$2, N as o, m as r$1, c1 as w, mN as p$4, oK as i$3, E as s, G, U, $ as s$1, mR as p$5, mS as k, mH as o$1, mK as d$2, nf as c$2, mZ as r$2, mT as s$2, eb as b } from './_virtual_index-1ea2035a.js';
import { N as N$1, L } from './SceneService-f34bce56.js';
import { a, d as d$1, b as a$1, c as a$2 } from './PointCloudUniqueValueRenderer-816ed1b5.js';
...
See https://js.arcgis.com/4.25/esri/copyright.txt for details.
*/
var p;let l=p=class extends l$1{constructor(e){super(e),this.mode="exclude",this.type="value",this.values=[];}clone(){return new p({field:this.field,mode:this.mode,values:y$1(this.values)})}};e$1([y({type:["exclude","include"],json:{write:{enabled:!0,isRequired:!0}}})],l.prototype,"mode",void 0),e$1([r({pointCloudValueFilter:"value"})],l.prototype,"type",void 0),e$1([y({type:[Number],json:{write:{enabled:!0,isRequired:!0}}})],l.prototype,"values",void 0),l=p=e$1([n$2("esri.layers.pointCloudFilters.PointCloudValueFilter")],l);const u=l;
...
See https://js.arcgis.com/4.25/esri/copyright.txt for details.
*/
var i$1;let c=i$1=class extends a{constructor(r){super(r),this.type="point-cloud-rgb",this.field=null;}clone(){return new i$1({...this.cloneProperties(),field:y$1(this.field)})}};e$1([r({pointCloudRGBRenderer:"point-cloud-rgb"})],c.prototype,"type",void 0),e$1([y({type:String,json:{write:!0}})],c.prototype,"field",void 0),c=i$1=e$1([n$2("esri.renderers.PointCloudRGBRenderer")],c);const n=c;
