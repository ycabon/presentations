import { d8 as proxyCustomElement, d9 as H, da as h, db as Host } from './_virtual_index-fc1e0009.js';
import { g as guid } from './guid-dba777c9.js';
import { g as getElementDir, q as queryElementRoots, t as toAriaBoolean } from './dom-acb49a3c.js';
...
class TooltipManager {
  ...
  addListeners() {
    ...
    document.addEventListener("focusin", this.focusShow);
...
const Tooltip = /*@__PURE__*/ proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return (h(Host, { "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "calcite-hydrated-hidden": hidden, id: this.getId(), role: "tooltip" }, h("div", { class: {
